...
module alu_manual_test #(
    ...
    localparam logic [4:0][0:0] _MP_RISE_787386805 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_787386805 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_787386805;
    
    generate
        for (idx_0_787386805 = 0; idx_0_787386805 < 5; idx_0_787386805 = idx_0_787386805 + 1) begin: forLoop_idx_0_787386805
            edge_detector #(
                .RISE(_MP_RISE_787386805[idx_0_787386805]),
                .FALL(_MP_FALL_787386805[idx_0_787386805])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_787386805]),
                .out(M_io_button_edge_out[idx_0_787386805])
            );
        end
    endgenerate
    
    
    localparam logic [4:0][23:0] _MP_CLK_FREQ_238957731 = {{24'h989680, 24'h989680, 24'h989680, 24'h989680, 24'h989680}};
    localparam _MP_MIN_DELAY_238957731 = 5'h14;
    localparam _MP_NUM_SYNC_238957731 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_238957731;
    
    generate
        for (idx_0_238957731 = 0; idx_0_238957731 < 5; idx_0_238957731 = idx_0_238957731 + 1) begin: forLoop_idx_0_238957731
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_238957731[idx_0_238957731]),
                .MIN_DELAY(_MP_MIN_DELAY_238957731),
                .NUM_SYNC(_MP_NUM_SYNC_238957731)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_238957731]),
                .out(M_io_button_cond_out[idx_0_238957731])
            );
        end
    endgenerate
    
    
    localparam _MP_RISE_168933151 = 1'h1;
    localparam _MP_FALL_168933151 = 1'h0;
    logic M_slow_clock_edge_in;
    logic M_slow_clock_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_168933151),
        .FALL(_MP_FALL_168933151)
    ) slow_clock_edge (
        .clk(clk),
    ...
    localparam _MP_DIGITS_1104755890 = 3'h4;
    localparam _MP_DIV_1104755890 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1104755890),
        .DIV(_MP_DIV_1104755890)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
    ...
    localparam _MP_DIGITS_730934232 = 3'h4;
    localparam _MP_LEADING_ZEROS_730934232 = 1'h1;
    logic [13:0] M_decimal_renderer_value;
    logic [3:0][3:0] M_decimal_renderer_digits;
    
    bin_to_dec #(
        .DIGITS(_MP_DIGITS_730934232),
        .LEADING_ZEROS(_MP_LEADING_ZEROS_730934232)
    ) decimal_renderer (
